(function(a){a.fn.smartWizard=function(k){var c=a.extend({},a.fn.smartWizard.defaults,k),u=arguments;return this.each(function(){function z(){var d=b.children("div");b.children("ul").addClass("anchor");d.addClass("content");l=a("<div>Loading</div>").addClass("loader");i=a("<div></div>").addClass("actionBar");m=a("<div></div>").addClass("stepContainer");n=a("<a id='nextId'>"+c.labelNext+"</a>").attr("href","#").addClass("buttonNext");o=a("<a id='PreviousId'>"+c.labelPrevious+"</a>").attr("href","#").addClass("buttonPrevious");
...
errorSteps:[],labelNext:"Next",labelPrevious:"上一步",labelFinish:"完成",onLeaveStep:null,onShowStep:null,onFinish:null}})(jQuery);