            ...
            $.each(items, function (key, val) {
                ...
                div.click(function () {
                    ...
                    if (val.items && val.items.length > 0) {
                        ...
                        if (sumMenu.css("display") == "none") {
                            sumMenu.css("display", "block")
                        } else {
                            sumMenu.css("display", "none");
                        }
                    } else {
                        ...
                        //                        var prevDiv = currentDiv.closest("ul").prev("div");
                        //                        if (prevDiv.length > 0) {
                        //                            prevDiv.addClass("selected_1");
                        //                        }
                        //                        while (prevDiv.length > 0) {
                        //                            prevDiv.addClass("selected_" + prevDiv.attr("level"));
                        //                            prevDiv = prevDiv.closest("ul").prev("div");
                        //                        }
