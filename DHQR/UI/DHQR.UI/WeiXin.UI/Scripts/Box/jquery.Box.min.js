...
DialogBoxConfig.stateDefaults = {
    content: '',
    buttons: { '确定': 'ok' },
    buttonsFocus: 0,
    submit: function (v, h, f) { return true; }
};
DialogBoxConfig.tipDefaults = {
    content: '',
    icon: 'info', top: '40%', width: 'auto',
    height: 'auto', opacity: 0, timeout: 3000,
    closed: function () { }
};
DialogBoxConfig.messagerDefaults = {
    content: '', /* 信息的内容，不支持前缀标识 */
    title: 'DialogBox', /* 信息的标题 */
...
DialogBoxConfig.languageDefaults = {
    close: '关闭', /* 窗口右上角关闭按钮提示 */
    ok: '确定', /* $.DialogBox.prompt() 系列方法的“确定”按钮文字 */
    yes: '是', /* $.DialogBox.warning() 方法的“是”按钮文字 */
    no: '否', /* $.DialogBox.warning() 方法的“否”按钮文字 */
    cancel: '取消' /* $.DialogBox.confirm() 和 $.DialogBox.warning() 方法的“取消”按钮文字 */
};
$.DialogBox.setDefaults(DialogBoxConfig); 