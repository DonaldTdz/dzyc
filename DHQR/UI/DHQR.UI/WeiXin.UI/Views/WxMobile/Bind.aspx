    ...
    <div class="wrap" id="bind">
        ...
        <div class="swiper">
            <div class="slide">
                ...
                <br />
                <input id="btn_bdUser" type="button" value="一键绑定" onclick="BindUser();" style="background: #00C76A; color: #FFFFFF;cursor:pointer;" />
            </div>
            <div class="slide one">
                ...
                <br />
                <input id="btn_bdInner" type="button" value="一键绑定" onclick="BindInnerUser();" style="background: #00C76A; color: #FFFFFF; cursor: pointer;" />
            </div>
        </div>
    </div>
    <div id="info">
        ...
        <div class="index_te">
            <input type="button" id="btn_remove" value="解除绑定" onclick="RemoveBind();" style="cursor:pointer;" />
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function BindUser() {
        ...
        if (OrderCode == "" || OrderPsw == "" || RetailerName == "" || RetailerTel == "") {
            ...
            $.ajax({
                ...
                error: function (e) {
                    alert(dohandle.OperateMsg);
                    $("#btn_bdUser").attr('disabled', false);
                    //$("#msg").text(e);
                    //$("#showA").click();
                }
    ...
    function BindInnerUser() {
        ...
        if (OrderCode == "" || OrderPsw == "" || RetailerName == "" || RetailerTel == "") {
            ...
            var postData = { UserType: UserType, SysName: OrderCode, SysPsw: OrderPsw, Name: RetailerName, Tel: RetailerTel, WxUserName: WxUserName, key: key };
            $("#btn_bdInner").attr('disabled', true);
            $.ajax({
                url: "BindUser",
                data: postData,
                type: "POST",
                ...
                error: function (e) {
                    alert(dohandle.OperateMsg);
                    $("#btn_bdInner").attr('disabled', false);
                }
