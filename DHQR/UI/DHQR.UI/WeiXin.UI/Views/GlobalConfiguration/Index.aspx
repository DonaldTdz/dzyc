        ...
        <div class="iframe_content">
            ...
            <div id="reply_keyword" class="r_con_wrap">
                <div class="control_btn">
                    <a href="../GlobalConfiguration/CreateOrEdit" class="btn_green btn_w_120">新增</a>
                </div>
                <table border="0" cellpadding="5" cellspacing="0" class="r_con_table">
                    <thead>
                        <tr>
                            <td width="15%" nowrap="nowrap">用途
                            </td>
                            <td width="15%" nowrap="nowrap">键
                            </td>
                            <td width="15%" nowrap="nowrap">值
                            </td>
                            <td width="10%" nowrap="nowrap">类型
                            </td>
...
<asp:Content ID="Content4" ContentPlaceHolderID="BottomScript" runat="server">
    <script type="text/javascript">
        ...
        function getPageData(pageIndex) {
            $.post("GetPageData", { Page: pageIndex, Rows: 10, Sidx: "Key" }, function (response) {
                ...
                $(dataRows).each(function (i) {
                    ...
                    var td = $('<td nowrap="nowrap"></td>');
                    td.append(dataRows[i].Key);
                    tr.append(td);

                    td = $('<td nowrap="nowrap"></td>');
                    td.append(dataRows[i].Value);
                    tr.append(td);

                    td = $('<td nowrap="nowrap"></td>');
                    td.append(dataRows[i].Type);
                    tr.append(td);
    

                    //操作
                    td = $('<td nowrap="nowrap" class="last"></td>');
                    var modifyATag = $('<a href="../GlobalConfiguration/CreateOrEdit?Id=' + dataRows[i].Id + '"><img src="../../DHQRImages/ico/mod.gif" align="absmiddle" alt="修改"></a>');
