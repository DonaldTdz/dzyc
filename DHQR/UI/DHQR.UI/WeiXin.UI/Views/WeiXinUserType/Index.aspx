...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="iframe_page">
        <div class="iframe_content">
            <div class="r_nav">
                <ul>
					<li class=""><a href="../WeiXinUser/Index">账号绑定管理</a></li>
					<li class="cur"><a href="../WeiXinUserType/Index">用户类型管理</a></li>
            ...
            <div id="url" class="r_con_wrap">
                ...
                <table border="0" cellpadding="5" cellspacing="0">
                    <tr>
                        <td>
                            代码
                            <input type="text" name="Code" id="Code" value="" size="25" class="form_input" notnull />
                        </td>
                        <td>
                            名称
                            <input type="text" name="Name" id="Name" value="" size="40" class="form_input" notnull />
                        </td>
                        <td>
                            <input type="button" class="submit" id="sub" value="添加类型" name="submit_btn" onclick="CreateOrUpdate();" />
                        </td>
                    </tr>
                </table>
...
<asp:Content ID="Content4" ContentPlaceHolderID="BottomScript" runat="server">
    ...
    <script type="text/javascript">
        ...
        function getPageData(pageIndex) {
            $.post("GetPageData", { Page: pageIndex, Sidx: "Code" }, function (response) {
                ...
                $(dataRows).each(function (i) {
                    ...
                    var efuc = "SetToEdit(" + "'" + dataRows[i].Id + "'" + "," + "'" + dataRows[i].Code + "'" + "," + "'" + dataRows[i].Name + "'" + ");"
                    ...
                    var delATag = $('<a href="javascript:void(0)" onclick="delData(this)" style="cursor:pointer;"><img src="../../DHQRImages/ico/del.gif" align="absmiddle" alt="删除"></a>');
                    td.append(delATag);
        ...
        function Create() {
            ...
            var postData = { Code: code, Name: name};
            $.ajax({
                url: "../WeiXinUserType/Create",
                data: postData,
                type: "POST",
                catche: false,
        ...
        function Update() {
            ...
            var postData = { Id: id, Code: code, Name: name };
            $.ajax({
                url: "../WeiXinUserType/Edit",
                data: postData,
                type: "POST",
                catche: false,
                success: function (data) {
        ...
        //设置编辑
        function SetToEdit(Id, Code, Name) {
            isCreate = false;
            $("#Id").val(Id);
            $("#Code").val(Code);
            $("#Name").val(Name);
