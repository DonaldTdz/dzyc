        ...
        <div class="iframe_content">
            ...
            <div id="reply_keyword" class="r_con_wrap">
                <div class="control_btn">
                    <a href="../WeiXinArticlesType/CreateOrEdit" class="btn_green btn_w_120">添加文章类型</a>
                </div>
                <table border="0" cellpadding="5" cellspacing="0" class="r_con_table">
                    <thead>
                        <tr>
                            ...
                            <td width="15%" nowrap="nowrap">代码
                            </td>
                            <td width="10%" nowrap="nowrap">排序号
                            </td>
                            
                          <%--  <td width="10%" nowrap="nowrap">创建时间
                            </td>--%>
                            <%--<td width="10%" nowrap="nowrap">创建人</td>--%>
                            <td width="20%" nowrap="nowrap">备注
                            </td>
...
<asp:Content ID="Content4" ContentPlaceHolderID="BottomScript" runat="server">
       ...
       {
           $.post("GetPageData", { Page: pageIndex, Rows: 10, Sidx: "Sort" }, function (response) {
               ...
               $(dataRows).each(function (i) {
                   ...
                   td = $('<td nowrap="nowrap"></td>');
                   td.append(dataRows[i].Sort);
                   tr.append(td);

                   //td = $('<td nowrap="nowrap"></td>');
                   //td.append(dataRows[i].CreateTime);
                   //tr.append(td);

                   //td = $('<td nowrap="nowrap"></td>');
                   //td.append(dataRows[i].creator);
                   //tr.append(td);
                   ...
                   var modifyATag = $('<a href="../WeiXinArticlesType/CreateOrEdit?Id=' + dataRows[i].Id + '"><img src="../../DHQRImages/ico/mod.gif" align="absmiddle" alt="修改"></a>');
