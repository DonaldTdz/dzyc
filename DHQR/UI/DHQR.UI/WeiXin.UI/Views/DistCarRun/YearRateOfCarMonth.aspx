        ...
        <div class="iframe_content">
            <div class="r_nav">
                <ul>
                    ...
                    <li class="cur"><a href="../DistCarRun/YearRateOfCarMonth">同比增长率(月)</a></li>
            ...
            <div id="stores" class="r_con_wrap" style="padding-bottom:0px;min-height:90px;">
                <div class="control_btn" style="padding-bottom:0px;height:15px;margin-bottom:12px;">
                    <div class="tips_info"><strong>提示：</strong>按柱状图展示选定配送车辆的费用同比增长率</div>
                </div>
                <form class="r_con_search_form" method="get">
                    <label>年度：</label>
                   <%=Html.DropDownList("SelYear",ViewData["YearList"] as IList<SelectListItem>,new { @class = "ui-text-select",@onchange="generateReport();"  }) %>
                    <label>月份：</label>
                   <%=Html.DropDownList("SelMonth",ViewData["MonthList"] as IList<SelectListItem>,new { @class = "ui-text-select",@onchange="generateReport();"  }) %>              
