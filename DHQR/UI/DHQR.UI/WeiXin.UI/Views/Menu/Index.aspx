        ...
        <div class="iframe_content">
            ...
            <div id="reply_keyword" class="r_con_wrap">
                <div class="control_btn">
                    <a href="../Menu/CreateOrEdit" class="btn_green btn_w_120">新增菜单</a>
                </div>
                <table border="0" cellpadding="5" cellspacing="0" class="r_con_table">
                    <thead>
                        <tr>
                            <td width="15%" nowrap="nowrap">名称
                            </td>
                            <td width="15%" nowrap="nowrap">路径
                            </td>
                            <td width="15%" nowrap="nowrap">父节点
                            </td>
                            <td width="10%" nowrap="nowrap">是否可见
                            </td>
                            <td width="10%" nowrap="nowrap">排序号
                            </td>
...
<asp:Content ID="Content4" ContentPlaceHolderID="BottomScript" runat="server">
    <script type="text/javascript">
        ...
        function getPageData(pageIndex) {
            $.post("GetPageData", { Page: pageIndex, Rows: 10, Sidx: "Sequence" }, function (response) {
                ...
                $(dataRows).each(function (i) {
                    ...
                    td = $('<td nowrap="nowrap"></td>');
                    td.append(dataRows[i].ParentMenuName);
                    tr.append(td);

                    td = $('<td nowrap="nowrap"></td>');
                    td.append(dataRows[i].IsVisible?"是":"否");
                    tr.append(td);

                    td = $('<td nowrap="nowrap"></td>');
                    td.append(dataRows[i].Sequence);
                    tr.append(td);

                    td = $('<td nowrap="nowrap"></td>');
                    td.append(dataRows[i].Icons);
                    tr.append(td);
                    //操作
                    td = $('<td nowrap="nowrap" class="last"></td>');
                    var modifyATag = $('<a href="../Menu/CreateOrEdit?Id=' + dataRows[i].Id + '"><img src="../../DHQRImages/ico/mod.gif" align="absmiddle" alt="修改"></a>');
