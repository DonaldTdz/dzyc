...
namespace DHQR.SynService
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //dlvManLogic.SynDZDlvmans("O00000000001161", out dohandle);//dlvManLogic.SynDlvmans(out dohandle);
            ...
            //rutLogic.SynDZDistRuts(out dohandle);//rutLogic.SynDistRuts(out dohandle);
            //Console.WriteLine(string.Format("同步完成，处理结果：{0}！", dohandle.OperateMsg));
            ...
            //Console.WriteLine(string.Format("开始同步线路数据！"));
            //carLogic.SynDZLdmCars(out dohandle);//carLogic.SynLdmCars(out dohandle);
            //Console.WriteLine(string.Format("同步完成，处理结果：{0}！", dohandle.OperateMsg));
