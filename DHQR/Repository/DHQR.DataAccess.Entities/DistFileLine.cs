...
namespace DHQR.DataAccess.Entities
{
    ...
    public partial class DistFileLine: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region 基元属性
        ...
        public string CRT_MAN_ID
        {
            ...
            set
            {
                if (_cRT_MAN_ID != value)
                {
                    _cRT_MAN_ID = value;
                    OnPropertyChanged("CRT_MAN_ID");
                }
            }
        }
