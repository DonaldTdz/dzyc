...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="iframe_page">
        <div class="iframe_content">
            <div class="r_nav">
                <ul>
					<li class=""><a href="../WeiXinUser/Index">零售户</a></li>
					<li class="cur"><a href="../WeiXinUser/InnerUser">内部员工</a></li>
...
<asp:Content ID="Content4" ContentPlaceHolderID="BottomScript" runat="server">
        <script type="text/javascript">
            ...
            function getPageData(pageIndex) {
                $.post("QueryData", { Page: pageIndex, KeyWord: $("#Keyword").val(), WeiXinUserTypeId: "1F598055-DDBB-498B-9083-8AFAF926334A" }, function (response) {
