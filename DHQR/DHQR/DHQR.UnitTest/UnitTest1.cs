...
namespace DHQR.UnitTest
{
    ...
    public class UnitTest1
    {
        ...
        public void TestMethod3()
        {
            ...
            string resultData;
            string data = "{'userName':'100112','psw':'654321','IsSuccessful':false}";
            var jser = new JavaScriptSerializer();
       ...
       public void TestCheckData()
       {
           ...
           var data = "{'CheckDatas':[{'ABNORMAL_DETAIL':'z00','ABNORMAL_TYPE':'z','CAR_ID':'GYd9c8961218181801121861b3430021','CHECK_TIME':'20151217011529','CHECK_TYPE':'3','OPERATE_MODE':'0','REF_ID':'GY000000136006','REF_TYPE':'1','USER_ID':'P0000000000000005279','IsSuccessful':false}],'IsSuccessful':false}";
           var jser = new JavaScriptSerializer();
           DoHandle dohandle;
       ...
       {
           var data = "{'CO_NUM':'XGY30001612643','CUST_ID':'510811102145','DIST_NUM':'GY000000136153','DIST_SATIS':'10','DLVMAN_ID':'P0000000000000005267','EVALUATE_INFO':'','EVALUATE_TIME':'20151219133621','EXP_SIGN_REASON':'','HANDOVER_TIME':'7','IS_RECEIVED':'01','REC_ARRIVE_TIME':'20151219133614','REC_DATE':'20151219','REC_LEAVE_TIME':'20151219133621','SIGN_TYPE':'3','UNLOAD_DISTANCE':'0.00','UNLOAD_LAT':'32.01792706','UNLOAD_LON':'105.88318328','UNLOAD_REASON':'20','IsSuccessful':false}";
           var jser = new JavaScriptSerializer();
           DoHandle dohandle;
       ...
       {
           var data = "{'CO_NUM':'GY100002981298','CUST_ID':'510824104803','DIST_NUM':'GY000000139736','DIST_SATIS':'10','DLVMAN_ID':'P0000000000000005294','EVALUATE_INFO':'','EVALUATE_TIME':'20160308162342','EXP_SIGN_REASON':'','HANDOVER_TIME':'7','IS_RECEIVED':'05','REC_ARRIVE_TIME':'20160308162335','REC_DATE':'20160308','REC_LEAVE_TIME':'20160308162342','SIGN_TYPE':'0','UNLOAD_DISTANCE':'11517673.00','UNLOAD_LAT':'31.74106275','UNLOAD_LON':'105.93422930','UNLOAD_REASON':'24','UNUSUAL_TYPE':'03','IsSuccessful':false}";
        ...
        {
            var data = "{'DIST_NUM':'GY000000136220','IsSuccessful':false}";
            var jser = new JavaScriptSerializer();
        ...
        {
            var data = "{'CARD_ID':'04800F4A0A3C80'}";
            var jser = new JavaScriptSerializer();
