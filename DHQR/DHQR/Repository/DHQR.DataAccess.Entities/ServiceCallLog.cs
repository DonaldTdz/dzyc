...
namespace DHQR.DataAccess.Entities
{
    ...
    public partial class ServiceCallLog: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region 基元属性
        ...
        public string RequestParam
        {
            ...
            set
            {
                if (_requestParam != value)
                {
                    _requestParam = value;
                    OnPropertyChanged("RequestParam");
                }
            }
        }
        ...
        [DataMember]
        public Nullable<bool> IsSucessful
        {
            get { return _isSucessful; }
            set
            {
                if (_isSucessful != value)
                {
                    _isSucessful = value;
                    OnPropertyChanged("IsSucessful");
                }
            }
        }
        private Nullable<bool> _isSucessful;
