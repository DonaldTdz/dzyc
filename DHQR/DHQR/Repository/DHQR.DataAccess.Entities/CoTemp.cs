...
namespace DHQR.DataAccess.Entities
{
    ...
    public partial class CoTemp: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region 基元属性
        ...
        public string RET_USER_ID
        {
            ...
            set
            {
                if (_rET_USER_ID != value)
                {
                    _rET_USER_ID = value;
                    OnPropertyChanged("RET_USER_ID");
                }
            }
        }
        ...
        [DataMember]
        public string FINISH_USER_ID
        {
            get { return _fINISH_USER_ID; }
            set
            {
                if (_fINISH_USER_ID != value)
                {
                    _fINISH_USER_ID = value;
                    OnPropertyChanged("FINISH_USER_ID");
                }
            }
        }
        private string _fINISH_USER_ID;
