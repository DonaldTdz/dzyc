...
namespace DHQR.DataAccess.Entities
{
    ...
    public partial class WeiXinLogistic: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region 基元属性
        ...
        {
            get { return _stateDsc; }
            set
            {
                if (_stateDsc != value)
                {
                    _stateDsc = value;
                    OnPropertyChanged("StateDsc");
                }
            }
        }
        private string _stateDsc;
